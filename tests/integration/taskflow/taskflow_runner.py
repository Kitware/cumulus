...
def main(config):
    ...
    try:
        ...
        taskflow_id = create_taskflow(
            client, 'testflows.mytaskflows.SimpleTaskFlow')
        ...
        taskflow_id = create_taskflow(
            client, 'testflows.mytaskflows.ChordTaskFlow')
        ...
        taskflow_id = create_taskflow(
            client, 'testflows.mytaskflows.ConnectTwoTaskFlow')
        ...
        taskflow_id = create_taskflow(
            client, 'testflows.mytaskflows.MyCompositeTaskFlow')
