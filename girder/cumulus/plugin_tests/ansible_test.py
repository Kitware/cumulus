...
class AnsibleTestCase(base.TestCase):
    ...
    def test_cluster_status(self):
        ...
        self.assertTrue("deploying" in names)
        self.assertTrue("deployed" in names)
        ...
        self.assertTrue(ClusterStatus.created < ClusterStatus.deploying)
        self.assertTrue(ClusterStatus.deploying < ClusterStatus.deployed)
        self.assertTrue(ClusterStatus.deployed < ClusterStatus.provisioning)
        self.assertTrue(ClusterStatus.provisioning < ClusterStatus.provisioned)
        self.assertTrue(ClusterStatus.provisioned < ClusterStatus.stopped)
